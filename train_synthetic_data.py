...
ap.add_argument("-s", "--steps", required=False, type=int, default=1, help="No. of steps per epochs (default=1).")
...
ap.add_argument("-se", "--saving_epochs", required=False, type=int, default=1000, help="In which steps should the weights be stored (default=100).")
