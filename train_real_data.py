...
# Start training
network.train_real_data(epochs=args["epochs"], steps=args["steps"], batch_size=args["batch_size"], weights_path=args["weights"], saving_epochs=args["saving_epochs"], dataset=dataset)
